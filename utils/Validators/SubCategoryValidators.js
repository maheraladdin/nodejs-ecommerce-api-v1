...
const {subCategoryNameRule, optionalSubCategoryNameRule, subCategoryIdRule, categoryIdRule, optionalCategoryIdRule } = require("../ValidatorRules/SubCategoryRules");
...
module.exports.createSubCategoryValidator = expressValidatorCallback([subCategoryNameRule, categoryIdRule]);
...
// @usage: use this validator in routes to validate subCategory data
// @note: this validator should be placed before the controller
module.exports.updateSubCategoryValidator = expressValidatorCallback([subCategoryIdRule, optionalSubCategoryNameRule, optionalCategoryIdRule]);
